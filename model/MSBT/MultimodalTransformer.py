...
class MultimodalTransformer(nn.Module):
    def __init__(self):
        ...
        self.fc_f = nn.Linear(512, hid_dim)
        ...
        self.MST = MultiScale_Bottleneck_Transformer(hid_dim, n_head=nhead, dropout=dropout, n_bottleneck=n_bottleneck, bottleneck_std=0.15)
        d_mmt = hid_dim * 6
        h_mmt = 6
    ...
    def forward(self, f_a, f_v, f_f, seq_len):  # audio, RGB, CLIP
